...
//			Project pro2 = new Project("New Employee Budget",  "COMPLETED", "Decide on a new employee bonus budget for the year and figureout who will be promoted");
//			Project pro3 = new Project("Office Reconstruction", "INPROGRESS", "The office building in Monroe has been damaged due to hurricane in the region. This needs to be reconstructed");
...
//
//			this.projectRepository.save(pro1);
//			this.projectRepository.save(pro2); 
//			this.projectRepository.save(pro3); 
//			this.projectRepository.save(pro4);
//		};
//	}
